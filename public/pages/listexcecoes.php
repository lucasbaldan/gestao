            ...
            <tbody>
                <?php foreach ($dados as $dadoExcecao) { ?>
                    <tr>
                        ...
                        <td><?= "<button class='ui mini icon button blue' onclick='editarRegistro(" . $dadoExcecao['CD_EXCECAO'] .",". $dadoExcecao['CD_FUNCIONARIO'] . ")'><i class='pencil alternate icon'></i></button>" ?>
